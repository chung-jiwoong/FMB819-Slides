...
-   핵심 아이디어 (Key Idea)
    ...
    -   각 개인은 **여러 개의 대체적 처리 상태(alternative treatment states)**에 노출될 수 있음.
...
::::: columns
::: {.column width="50%"}
처리 변수 $D_i$를 **이진 변수(binary variable)**로 정의 $$
D_i = \begin{cases} 
...
📌 이런 "단순 비교" 방식은 종종 기자, 정치인, 그리고 훈련이 부족한 연구자들에 의해 사용됨. 
:::
:::::
...
-   데이터 다운로드 [링크](https://www.dropbox.com/s/oqc3vq1m9eyp1d6/toy_data_2.csv?dl=1)\
