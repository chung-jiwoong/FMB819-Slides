...
ggroc(roc_obj, color = "#d90502", linewidth = 1.3) +
  ...
  labs(title = "ROC Curve",
       x = "1 - Specificity: Rate of non-defaulters incorrectly classified as Yes (lower is better)",
       y = "Sensitivity: Rate of actual defaulters correctly classified as Yes (higher is better)") +
  theme_bw(base_size = 14)
```
