...
-   ⚠️ **위 해석은** $x$의 작은 변화와 $b_1$이 작은 경우에만 유효: $x$의 변화가 클 경우 또는 $b_1$ 값이 크다면, 해석이 달라질 수 있음. 보다 일반적인 해석이 궁금하다면 [링크](#gen_log))
...
-   *STAR* 실험 데이터: 작은 학급과 일반 학급의 효과는 **교사의 경험**에 따라 어떻게 달라지는가?
