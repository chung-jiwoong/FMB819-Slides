...
표본이 충분히 크면, $\hat{\beta}_1$은 정규 분포를 따름:

$$\hat{\beta}_1 \approx N\!\left(\beta_1,\; SE^2\right)$$

**② 표준화 (z-변환)**

$$z = \frac{\hat{\beta}_1 - \beta_1}{SE} \approx N(0,\, 1)$$
...
$$\therefore\quad \hat{\beta}_1 \pm 1.96 \times SE$$
